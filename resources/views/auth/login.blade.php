    ...
    <main class="flex-grow flex flex-col items-center justify-center p-4 py-12 relative overflow-hidden text-slate-300">
        <div class="w-full max-w-md bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8 sm:p-12 relative z-10 group overflow-hidden">
            ...
            <div class="mt-10 pt-6 border-t border-white/10 relative z-10">
                <p class="text-[11px] sm:text-xs text-slate-500 text-center leading-relaxed font-medium">
                    By continuing, you agree to our <br class="sm:hidden" />
                    <a href="{{ route('tos') }}" class="text-cyan-500 hover:text-cyan-400 transition-colors font-bold hover:underline underline-offset-4">Terms of Service</a> and
                    <a href="{{ route('privacy') }}" class="text-cyan-500 hover:text-cyan-400 transition-colors font-bold hover:underline underline-offset-4">Privacy Policy</a>.
                </p>
            </div>
        </div>
    </main>

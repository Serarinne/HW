...
class RedeemController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.redeems.index', compact('codes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.redeems.index')->with('success', 'Code created successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.redeems.index')->with('success', 'Code updated successfully!');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('admin.redeems.index')->with('success', 'Code deleted successfully!');
    }
}